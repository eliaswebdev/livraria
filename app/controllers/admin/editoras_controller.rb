class Admin::EditorasController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @editora.save
        format.html { redirect_to [:admin, @editora], notice: 'Editora was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @editora.update(editora_params)
        format.html { redirect_to [:admin, @editora], notice: 'Editora was successfully updated.' }
  ...
  def destroy
    @editora.destroy
    respond_to do |format|
      format.html { redirect_to admin_editoras_url, notice: 'Editora was successfully destroyed.' }
