class Admin::LivrosController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @livro.save
        format.html { redirect_to [:admin, @livro], notice: 'Livro was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @livro.update(livro_params)
        format.html { redirect_to [:admin, @livro], notice: 'Livro was successfully updated.' }
  ...
  def destroy
    @livro.destroy
    respond_to do |format|
      format.html { redirect_to admn_livros_url, notice: 'Livro was successfully destroyed.' }
