class Admin::AutoresController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @autor.save
        format.html { redirect_to [:admin, @autor], notice: 'Autor was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @autor.update(autor_params)
        format.html { redirect_to [:admin, @autor], notice: 'Autor was successfully updated.' }
  ...
  def destroy
    @autor.destroy
    respond_to do |format|
      format.html { redirect_to admin_autores_url, notice: 'Autor was successfully destroyed.' }
